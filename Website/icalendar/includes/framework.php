...
require_once(_ZAPCAL_BASE . '\icalendar\includes\date.php');
require_once(_ZAPCAL_BASE . '\icalendar\includes\recurringdate.php');
require_once(_ZAPCAL_BASE . '\icalendar\includes\ical.php');
require_once(_ZAPCAL_BASE . '\icalendar\includes\timezone.php');
